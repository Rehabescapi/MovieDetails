...
export default class RecentMovies extends Component {
	...
	componentWillMount() {
		...
		'&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&primary_release_date.lte=2016-12-31&with_genres=10751')
	...
	render() {
		...
		return (
			<div id='list'>
				<h2>Family Movies</h2>
				<MovieList movies={movies} ListType='familyList'/>
			</div>
		)}
};
